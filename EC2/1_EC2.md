...
- EC2 Changing Instance Type
    ...
    - Stop instance first and change to another type like t2.large 
    
# 1. Placement Group
- Cluster, SAME AZ and SAME Hardware
    - **Not all types of EC2 can be placed in a Cluster placement group, eg t2.micro cannot**
...
- You can't copy an encrypted AMI that was shared with you from another account.
    ...
    - 可以先使用别人的AMI创建一个EC2，在将这个EC2创建一个AMI，这个AMI就属于你自己了
