...
- Application Load Balancer可以进行基于路径的路由（Path Patterns）。即可以根据用户请求中的URL字段不同来将请求发送到不同的目标组中。比方可以定义ELB，将访问`https://iteablue.com/posts/*`文章的流量转发到目标组1中，然后将访问`https://iteablue.com/pages/*`页面的流量转发到目标组2中，那么就可以把原本的一个网页应用程序分解成更小的服务单元
  ![](https://i.loli.net/2019/06/20/5d0b2e13028a254794.png)
  ![](https://i.loli.net/2019/08/02/5d43b38ba9c7474916.png)
- ALB可以侦听HTTP数据包头部的信息，根据此字段来定义规则
  ![](https://i.loli.net/2019/08/02/5d43b331dec0b80807.png)
